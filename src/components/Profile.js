...
import { matchStateToTerm, upperCaseFirstLetter } from "../latteHelper";
    ...
    return (
      <div>
        <div
          id="welcomeContainer"
          className="row phl"
          onTouchStart={this.onWelcomeContainerTouchStart}
        >
          {this.props.matched !== "null" && (
            <p className="typeGoodIndicator typeEmphasize">
              Your last match was:
              <a
                href={intranetprofileUri.concat(this.props.matched)}
                target="blank"
                className="linkForward"
              >
                {" " + this.props.matched.concat("TODO@emailDomain.com")}
              </a>
            </p>
          )}
          {this.props.matched === "null" &&
            this.props.isPendingMatch && (
        ...
        <div id="interestContainer" className="row phl">
          <p className="pvm" onTouchStart={this.onWelcomeContainerTouchStart}>
            Tell us a little about yourself and we will match you with a coffee
            buddy.
          </p>
          <h6>
            Interests{" "}
            <span className="plm maxInterestHelperText typeLowlight">
              10 max, e.g. 'Cooking', or 'Travel'{" "}
            </span>
          </h6>
          <form className="form">
            <div className="field">
              <span className="fieldItem text">
                <Autocomplete
                  ...
                  wrapperProps={{
                    className:
                      "miniCol24 xxsCol20 xsCol18 smlCol20 mdCol18 lrgCol16 pan prm"
                  }}
                  ...
                  onChange={(event, value) =>
                    this.props.onAutoCompleteValueChange(value)
                  }
                ...
                <div className="miniCol24 xxsCol20 xsCol18 smlCol20 mdCol18 lrgCol16 pln">
                  <SelectedInterests
                    ...
                    onClickSelectedInterestHandler={
                      this.props.onClickSelectedInterestHandler
                    }
                  />
                </div>
              </span>
            ...
            {!this.props.isInputValid && (
              <div className="typePoorIndicator">
        ...
        <div className="row pvm phl">
          <div className="miniCol24 xxsCol10 pln">
            ...
            >
              {this.props.matched === "null" &&
              this.props.isPendingMatch === "false"
                ? "Find a coffee buddy"
                : "Re-Match"}
            </button>
          </div>
